...
class EditBranch(Frame):
    ...
    def new_branch(self, branch, branch_iD):
...
if __name__ == "__main__":
    win = tk.Tk()
    fr = EditBranch("negin", "negin_dvz", win)
    win.mainloop()
