...
class EditUserView(Frame):
    ...
    def __init__(self, name, username, master=None, callback=None,
                 callback1=None,
                 callback2=None):
        ...
        # press Enter to go next, stop click in!
        ...
        self.ent_pass.bind("<Return>",
                           lambda _: self.entries[3].focus_set())
        self.ent_id.bind("<Return>", lambda _: self.btn_submit.invoke())
    ...
    def return_data(self):
        ...
        new_data = (self.username, new_username, new_id, new_pass, new_name)
...
if __name__ == "__main__":
    win = tk.Tk()
    fr = EditUserView("siamak", "siamak_sdi", win)
    win.mainloop()
